...
contract UniswapV2PracticeTest is Test {
    ...
    function test_maker_addLiquidityETH() public {
        ...
        // Implement here
        UNISWAP_V2_ROUTER.addLiquidityETH{value: 100 ether,gas: 1000000}(
            address(testUSDC),
    ...
    function test_taker_swapExactETHForTokens() public {
        ...
        UNISWAP_V2_ROUTER.swapExactETHForTokens{value: 1 ether,gas: 1000000}(
            0,
            path,
            taker,
            block.timestamp + 100
    ...
    function test_maker_removeLiquidityETH() public {
        ...
        vm.startPrank(maker);
        testUSDC.approve(address(UNISWAP_V2_ROUTER), 10000 * 10 ** testUSDC.decimals());
        (,,uint liquidity) = UNISWAP_V2_ROUTER.addLiquidityETH{value: 100 ether,gas: 1000000}(
            address(testUSDC),
            10000 * 10 ** testUSDC.decimals(),
            0,
            0,
        ...
        // Implement here
        address getPair = UNISWAP_V2_FACTORY.getPair(address(WETH9), address(testUSDC));
        TestERC20(getPair).approve(address(UNISWAP_V2_ROUTER), liquidity);
        testUSDC.approve(address(UNISWAP_V2_ROUTER), liquidity);
        // removeLiquidityETH
